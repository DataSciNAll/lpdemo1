# US OCP Learning Plan for Azure - Application Innovation - Modernize/New OSS Applications
...
* [Play with Docker Classroom](https://training.play-with-docker.com/) (Self-Paced)
...
* [Katacoda: Learn Docker & Containers using Interactive Browser-Based Scenarios](https://www.katacoda.com/courses/docker/) (Self-Paced)
...
* [Learning Path: SQL Server on Linux](https://docs.microsoft.com/en-us/learn/paths/sql-server-2017-on-linux/) (Self-Paced) (3 Hours)
* [Build and run a web application with the MEAN stack on an Azure Linux virtual machine](https://docs.microsoft.com/en-us/learn/modules/build-a-web-app-with-mean-on-a-linux-vm/) (Self-Paced) (1 Hour)
